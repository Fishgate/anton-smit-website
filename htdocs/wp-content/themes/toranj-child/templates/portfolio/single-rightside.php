...
<div id="main-content" class="dark-template">
	...
	<div class="page-wrapper rightside-folio">
		...
		<div class="page-main">
			<div class="inner-wrapper">
				<?php $img_url = wp_get_attachment_url( get_post_thumbnail_id($post->ID) , 'port-single-right-1080p' ); ?>
                            
                                <?php //$img_url = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'port-single-right-1080p' ); ?>
